...
import DeleteIcon from '../../assets/trash-blank-svgrepo-com.svg'
...
function CartItems() {
  ...
  return (
    <div className={styles.cartItems}>
      ...
      {cartValue.map((item) => {
        return <CartItem key={item.title} qty={item.qty} price={item.price} title={item.title} image={item.image}/>
      })}
    </div>
  );
}
